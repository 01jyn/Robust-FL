...
Project_Path = r'/home/yanan/Robust_FL-Master-cf/Robust_FL-master/'
...
def init_logs(log_level=logging.INFO,log_path = Project_Path+'Logs/',sub_name=None):
    ...
    if sub_name == None:
        log_name = log_path + filename + '_' + sys.argv[1] + 'l1ce-4res12_2_sym.log'
    else:
        log_name = log_path + filename + '_' + sub_name + '_' + sys.argv[1] +'l2-res_2_sym.log'
    logfile = log_name
